        ...
        <div class="checkout-form-container">
            <form id="checkoutForm" @submit="handleSubmit" novalidate autocomplete="off">
                <div class="checkout-heading">
                    ...
                    <h3 v-if="user">{{ user.user_name }}'s Order<span>₹{{ calculateSummaryPrice()[2] }}</span></h3>
                </div>
                ...
                <div class="form-group details-group">
                    ...
                    <div class="form-group">
                        <input type="text" name="coAddress" id="coAddress" placeholder="Address in kerala"
        ...
        async handleSubmit(e) {
            ...
            if (!this.checkEmptyErr()) {
                ...
                let billStatus = {
                    ...
                    bill_delivery: parseInt(this.calculateSummaryPrice()[1]),
                    bill_total: parseInt(this.calculateSummaryPrice()[2]),
