                    ...
                    <div class="col-md-3">
                        <div class="box">
                            ...
                            <div class="box-content">
                                ...
                                <h3 class="font-bold total-delivery">₹{{ calculateSummaryPrice()[1] }}</h3>
                                <hr />

                                <span>Total</span>
                                <h2 class="font-bold total-sale">₹{{ calculateSummaryPrice()[2] }}</h2>
...
export default {
    ...
    methods: {
        ...
        calculateItemPrice: function (index) {
            return ((parseInt(this.filterFoods[index].food_price)) * this.itemQuantity[index]).toString()
        },
