<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/taco-logo.png" alt="" />Foodies
        </router-link>
...
export default {
    ...
    this.setUser(undefined); // Clear Vuex state
    localStorage.removeItem("user"); // Clear localStorage
    this.$router.push("/login"); // Optional: redirect to login page
       }
    }
}
</script>
